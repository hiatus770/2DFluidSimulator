...
public:
    ...
    StarChunk(float ChunkX, float ChunkY, float ChunkZ)
    {
        ...
        // Create shader
        starShader = new Shader("/home/hiatus/Documents/2DFluidSimulator/src/shaders/vertInstanced.vs", "/home/hiatus/Documents/OPENGLPROJECT/BetterShaders/src/shaders/fragInstanced.fs");
